...
func _enter_tree() -> void:
	...
	if name.is_valid_int():
		...
		# --- KLUCZOWA POPRAWKA MULTIPLAYER ---
		# Musimy jawnie ustawić autorytet dla synchronizatora, 
		# aby wiedział, że ma przesyłać pozycję OD KLIENTA DO SERWERA.
		if has_node("MultiplayerSynchronizer"):
			$MultiplayerSynchronizer.set_multiplayer_authority(player_id)
		# -------------------------------------
			
		print("[SIEĆ] Przypisano autorytet dla auta i synchronizatora ", name, " do gracza: ", player_id)
