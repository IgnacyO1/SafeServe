...
func _click():
	...
	await get_tree().current_scene.radio.show_radio_message("W remizie jest jeden zapasowy wóz, pojedź nim z Robertem ", "res://assets/Sounds/scena 1/wremizieniemawozu.mp3")
